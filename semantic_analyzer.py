"""
Analizador Semántico Final
==========================
Basado exactamente en la implementación original del main_old.py
"""
...
class Symbol:
    ...
    def __init__(self, name, symbol_type, data_type=None, initialized=False, params=None, return_type=None):
        ...
        self.initialized = initialized  # Si la variable ha sido inicializada
        self.used = False               # Si el símbolo ha sido usado
        self.params = params or []      # Para funciones: lista de parámetros
        self.return_type = return_type  # Para funciones: tipo de retorno
        self.defined_at = None          # Nodo donde se definió
...
class SymbolTable:
    ...
    def __init__(self):
        ...
        self.scope_names = ['global']  # Nombres de los ámbitos
